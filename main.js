...
slider.style.transform = 'translateX(' + (i) * -80 + '%)';
index = i;
...
slider.style.transform = 'translateX(' + (index) * -80 + '%)';
});
...
slider2.style.transform = 'translateX(' + (i) * -80 + '%)';
index = i;
...
slider2.style.transform = 'translateX(' + (index) * -80 + '%)';
});
